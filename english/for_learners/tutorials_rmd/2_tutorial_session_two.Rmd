...
Up until now we have been using files and objects that are already spatial - i.e. they came from an R spatial package or GIS. Now we are going to move onto looking at data that are not yet in a spatial format, they could just be a spreadsheet or text file that you have created yourself.
